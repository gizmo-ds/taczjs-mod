package dev.aika.taczjs.neoforge.events;

import dev.aika.taczjs.neoforge.events.asset.AttachmentDataLoadEvent;
import dev.aika.taczjs.neoforge.events.asset.AttachmentTagsLoadEvent;
import dev.aika.taczjs.neoforge.events.asset.GunDataLoadEvent;
import dev.aika.taczjs.neoforge.events.index.AmmoIndexLoadEvent;
import dev.aika.taczjs.neoforge.events.index.AttachmentIndexLoadEvent;
import dev.aika.taczjs.neoforge.events.index.GunIndexLoadEvent;
import dev.aika.taczjs.neoforge.events.shooter.*;
